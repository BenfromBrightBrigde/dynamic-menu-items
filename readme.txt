...
Easily add post, pages, media links, or custom post types to any admin menu. Filter dynamic menu items by terms within a specific taxonomy and meta fields. Order dynamic menu items by name, date, or id. Include menu items by all or any one term specified.
...
= 1.0.1: March 12, 2026 =
* resolving error when adding unique post types to menu items. Adjustments made to stay up to date with most recent WordPress version (6.9.4)
